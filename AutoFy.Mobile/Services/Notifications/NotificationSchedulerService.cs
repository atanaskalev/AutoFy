...
namespace AutoFy.Mobile.Services.Notifications
{
    public class NotificationSchedulerService : INotificationSchedulerService
    {
        ...
        public async Task ScheduleReminderNotificationsAsync(
            int reminderId,
        ...
        public async Task ScheduleVehicleDeadlineNotificationsAsync(
            int vehicleId,
            DateTime? date,
            string deadlineName,
            string vehicleName)
        ...
        public async Task CancelVehicleDeadlineNotificationsAsync(
            int vehicleId,
            string deadlineKey)
        {
    ...
    DateTime notifyTime)
        ...
        private static int GetVehicleDeadlineNotificationId(
            int vehicleId,
            string deadlineKey,
            int offset)
        {
